...
(function () {
    ...
    ***************************************************************************** */
    ...
    var BoxRenderer = /** @class */ (function () {
        ...
        BoxRenderer.prototype._internal_draw = function (ctx, pixelRatio, isHovered, hitTestData) {
            if (this._private__data === null) {
                return;
            }
            if (this._private__data._internal_visible === false) {
    ...
    var SeriesBoxPaneView = /** @class */ (function () {
        ...
        SeriesBoxPaneView.prototype._internal_renderer = function (height, width) {
            if (!this._internal__series._internal_visible()) {
                return null;
            }
            if (this._private__invalidated) {
    ...
    var CustomBoxPaneView = /** @class */ (function (_super) {
        ...
        CustomBoxPaneView.prototype._internal__updateImpl = function (height, width) {
            ...
            data._internal_visible = false;
            var boxOptions = this._private__box._internal_options();
            if (!this._internal__series._internal_visible()) {
                return;
            }
            var yLow = this._private__box._internal_yLowCoord();
            var yHigh = this._private__box._internal_yHighCoord();
            if (yLow === null || yHigh === null) {
                return;
            }
            var xLow = this._private__box._internal_xLowCoord();
            var xHigh = this._private__box._internal_xHighCoord();
    ...
    var CustomBox = /** @class */ (function () {
        ...
        // }
        CustomBox.prototype._internal_update = function () {
            this._private__boxView._internal_update();
            // this._priceAxisView.update();
        };
        CustomBox.prototype._internal_xLowCoord = function () {
            return this._private__xCoord(this._private__options.earlyTime);
        };
        CustomBox.prototype._internal_xHighCoord = function () {
            return this._private__xCoord(this._private__options.lateTime);
        };
        CustomBox.prototype._internal_yLowCoord = function () {
            // low Y coord = the high price (it is intentionally flipped)
            return this._private__yCoord(this._private__options.highPrice);
        };
        CustomBox.prototype._internal_yHighCoord = function () {
            // high Y coord = the low price (it is intentionally flipped)
            return this._private__yCoord(this._private__options.lowPrice);
        };
        CustomBox.prototype._private__xCoord = function (time) {
        ...
        CustomBox.prototype._private__yCoord = function (price) {
            var series = this._private__series;
    ...
    var Series = /** @class */ (function (_super) {
        ...
        Series.prototype._internal_removeBox = function (box) {
    ...
    var SeriesApi = /** @class */ (function () {
        ...
        SeriesApi.prototype.createBox = function (options) {
            ...
            var box = this._internal__series._internal_createBox(strictOptions);
            return new Box(box);
        };
